              ...
              <div className="grid md:grid-cols-2 gap-6">
                {filteredComplaints.map((c, index) => {
                  ...
                  return (
                    <div
                      key={c.id}
                      className="bg-gradient-to-br from-white to-gray-50 rounded-xl border-2 border-gray-200 overflow-hidden hover:shadow-xl hover:border-teal-300 transition-all duration-300"
                      ...
                      <div className="p-5">
                        ...
                        {!isExpanded && c.description?.length > 100 && (
                          <button
                            ...
                            className="text-teal-600 text-xs font-medium mb-3 hover:underline flex items-center gap-1"
                          >
                            <Eye size={14} />
                            Read more
                          </button>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs">
                          <div className="flex items-center gap-2 bg-gray-100 rounded-lg px-3 py-2">
                            ...
                            <span className="font-semibold text-gray-700">{c.issue_type}</span>
                          </div>
                          <div className="flex items-center gap-2 bg-gray-100 rounded-lg px-3 py-2">
                            <span className="text-gray-500">Area:</span>
                            <span className="font-semibold text-gray-700">{c.area}</span>
                          </div>
                        </div>
                      </div>
                    </div>
